          ...
          <CartProvider>
            <Router future={{ v7_relativeSplatPath: true }}>
              <AuthProvider>
                ...
                <Route path="/role-names" element={<RoleBasedRoute allowedRoles={['super_admin']}><RoleNameManagementList /></RoleBasedRoute>} />
                <Route path="/role-names/:theaterId" element={<RoleBasedRoute allowedRoles={['super_admin']}><RoleNameManagement /></RoleBasedRoute>} />
