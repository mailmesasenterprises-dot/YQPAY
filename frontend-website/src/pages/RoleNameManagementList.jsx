...
const RoleNameManagementList = () => {
  ...
  // Fetch theaters function (same as RoleManagementList)
  ...
  const handleRoleNameManagementClick = (theater) => {
    navigate(`/role-names/${theater._id}`);
  };
  ...
  if (error) {
    return (
      <AdminLayout pageTitle="Email Notification Management" currentPage="role-names">
