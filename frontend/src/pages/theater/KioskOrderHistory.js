  ...
  const fetchOrders = useCallback(async () => {
    try {
      ...
      if (data.success && data.orders) {
        ...
        console.log('📱 Filtered out (non-kiosk):', data.orders.length - kioskOrders.length);
        ...
        throw new Error(data.message || 'Failed to fetch kiosk orders');
      }
      ...
      <TheaterLayout currentPage="kiosk-order-history" pageTitle="Kiosk Order History">
        <PageContainer title="Kiosk Order History" showBackButton={false}>
          <div className="qr-management-page">
            ...
            {/* Orders Table */}
            <div className="qr-management-table-container">
                    ...
                    <tr>
                      <td colSpan="9" className="no-data">
                        <div className="empty-state">
                          ...
                          <p>No kiosk orders have been placed yet or match your current filters.</p>
                        </div>
                      </td>
                    </tr>
                  ) : (
