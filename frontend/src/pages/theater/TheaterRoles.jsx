          ...
          <table className="theater-table">
            <thead>
              <tr>
                ...
                <th className="photo-cell">Icon</th>
                <th className="name-cell">Role Name</th>
                <th className="status-cell">Status</th>
                <th className="status-cell">Access Status</th>
              ...
              {loading ? (
                    ...
                    <tr key={role._id} className="theater-row">
                      ...
                      <td className="name-cell">
                        <div className="role-name-wrapper">
                          <strong>{role.name || 'No Name'}</strong>
                          {role.isDefault && (
                ...
                <tr>
                  <td colSpan="6" className="empty-cell">
                    ...
                    <p>There are no roles available for management at the moment.</p>
                    <button className="add-theater-btn" onClick={handleCreateNewRole}>
                      Create First Role
                    </button>
                  </td>
                </tr>
